export const categoryStyles = {
  ...
  "Sparkling Wine": {
    ...
    tintColor: "rgba(241, 245, 249, 0.1)", // Light tint for backgrounds
  },
  "Dessert Wine": {
    backgroundColor: "linear-gradient(135deg, rgba(252, 211, 77, 0.85) 0%, rgba(245, 158, 11, 0.85) 100%)", // Golden dessert wine color
    textColor: "#1f2937",
    displayName: "Dessert",
    tintColor: "rgba(252, 211, 77, 0.1)", // Light tint for backgrounds
  },
  "Fortified Wine": {
    ...
    tintColor: "rgba(146, 64, 14, 0.1)", // Light tint for backgrounds
  },
};
