...
interface WorkingWineSummaryDialogProps {
  wine: Wine;
...
export function WorkingWineSummaryDialog({
  wine,
  criteria,
  isOpen,
  onClose,
  onSubmit,
}: WorkingWineSummaryDialogProps) {
  ...
  return (
    <WorkingDialog isOpen={isOpen} onClose={onClose}>
